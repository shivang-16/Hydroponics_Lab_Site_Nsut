...
export const Training = () => {
  const trainingPrograms = [
    {
      image: "https://static.wixstatic.com/media/769cbd_5989abe750bf45008c20b958d91ead5a~mv2.jpeg",
      title: "2-Day Introductory Workshop",
      instructor: "Dr. Akhilesh Dubey",
      details: "10 lectures | 2 hours Hands on sessions",
      price: "Rs. 499",
      rating: 5,
      idealFor: "Beginners, curious hobbyists, and enthusiasts looking to get a taste of hydroponics.",
      overview: "This immersive 2-day workshop is designed to introduce you to the basics of hydroponic gardening. You'll learn essential techniques, from setting up simple systems to understanding nutrient management. This workshop combines theoretical sessions and hands-on exercises, helping you experience hydroponic cultivation from seed to harvest."
    },
    {
      image: "https://static.wixstatic.com/media/769cbd_5989abe750bf45008c20b958d91ead5a~mv2.jpeg",
      ...
      price: "Rs. 999",
      rating: 5,
      idealFor: "Aspiring hydroponics entrepreneurs, agriculture students, and professionals seeking a deeper understanding of hydroponic systems.",
      overview: "Our 1-week program offers an in-depth exploration of hydroponic farming techniques and system management. Through a blend of classroom learning and practical exercises, participants will gain comprehensive knowledge on hydroponic setups, crop management, pest control, and more advanced nutrient strategies."
    },
    {
      image: "https://static.wixstatic.com/media/769cbd_5989abe750bf45008c20b958d91ead5a~mv2.jpeg",
      ...
      price: "Rs. 1499",
      rating: 5,
      idealFor: "Entrepreneurs, researchers, and serious practitioners aiming to master hydroponics and develop professional-level expertise.",
      overview: "Our 8-week training is an advanced, all-encompassing course that dives deeply into all aspects of hydroponic horticulture. Participants will gain expertise in hydroponic system design, crop optimization, nutrient formulation, and data-driven plant management using innovative technologies."
    }
  ];
    ...
    <div className="min-h-screen w-full relative">
      ...
      <div className="relative h-[600px]">
        ...
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 
          ...
          <p className="text-base text-white leading-relaxed font-['Questrial'] text-center">
            At the Centre of Excellence in Hydroponics, we offer diverse training programs to cater to all levels of interest
            and experience—from newcomers to seasoned practitioners. Each program is tailored to provide a hands-on
            understanding of hydroponic horticulture, plant management, and sustainable cultivation practices.
          </p>
            ...
            <div key={index} className="mb-8 last:mb-0">
              <div className="grid grid-cols-[355px,1fr,auto] gap-16 items-start">
                ...
                <div className="text-white text-left pr-16">
                  <div className="mb-4">
                    <h2 className="text-[28px] font-['Marcellus'] font-extrabold tracking-wide mb-0.5">{program.title}</h2>
                  ...
                  <div className="space-y-4">
                    <p className="font-['Questrial'] text-white/90 leading-snug">
                      <span className="font-['Marcellus'] font-extrabold text-base">Ideal for:</span> {program.idealFor}
                    </p>

                    <div>
                      <h3 className="text-lg font-['Marcellus'] font-extrabold tracking-wide mb-1">Overview:</h3>
                      <p className="font-['Questrial'] text-white/90 leading-snug">
                        {program.overview}
                      </p>
                    </div>
      ...
      <div className="bg-[#e6ffe6] text-[#003300] py-20">
        <div className="container mx-auto px-16 text-center">
          ...
          >
            No matter your background, you can make a meaningful contribution to the 
            future of agriculture. Begin your journey with us and become a leader in 
            sustainable farming!
          </motion.p>
        </div>
      </div>
